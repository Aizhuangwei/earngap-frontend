...
export default function HomePage() {
  ...
  const scoreColors: Record<string, string> = { high:'#059669', mid:'#2563eb', low:'#d97706' };
    ...
    <div style={{ background:'#f8f9fa', color:'#0f172a', minHeight:'100vh', fontFamily:'Inter, -apple-system, sans-serif' }}>
      ...
      <main style={{ maxWidth:800, margin:'0 auto', padding:'40px 24px 64px' }}>
        <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', marginBottom:24 }}>
          <div>
            <h1 style={{ fontSize:28, fontWeight:800, marginBottom:4 }}>Signals</h1>
            <p style={{ fontSize:14, color:'#64748b' }}>8 active signals</p>
          </div>
          <div style={{ fontSize:13, color:'#94a3b8', cursor:'pointer' }} onClick={switchLang}>{lang === 'en' ? '中文' : 'EN'}</div>
        </div>
